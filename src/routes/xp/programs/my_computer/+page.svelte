<script>
    ...
    import Viewer from '../my_computer/viewer/+page.svelte';
    import * as finder from '../../../../lib/finder'
    import Sidebar from '../my_computer/sidebar/+page.svelte';
                ...
                [
                    {
                        ...
                        action: () => open_link('https://web.archive.org/web/20020916202544/http://microsoft.com/windowsxp/pro/default.asp')
                    },
                    {
