    ...
    function on_key_pressed(e) {
		 switch(e.keyCode) {
			 ...
			 case 40:
				...
				break;
			 case 13:
                dispatcher('load_page', {url: './installation/dos/partition/+page.svelte'});
				 break;
            case 27:
                dispatcher('load_page', {url: './boot_manager/+page.svelte'});
                break;
		 }
	}
...
<StatusBar bind:this={status_bar} l_message="ENTER=I agree&nbsp;&nbsp;&nbsp; ESC=I'm a pirate&nbsp;&nbsp;&nbsp; ↓(Down)=Next page&nbsp;&nbsp;&nbsp;↑(Up)=Previous page" />
