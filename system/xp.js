...
$.fn.initWindows = function() {
  ...
  windowsEl.append(`
    <div class="ui_desktop" id="_ui_desktop">
      <div tabindex="0" data-exe="openLocation('My Computer')" data-target="My Computer" class="ui_icon" style="position:absolute;left:0px;top:5px;">
        <div class="icon icon_computer"></div>
        <span>My Computer</span>
      </div>
      
      <div tabindex="1" data-exe="openLocation('/Documents and Settings/' + xp.profile.name + '/My Documents')" class="ui_icon" style="position:absolute;left:0px;top:70px;">
        <div class="icon icon_myDocuments"></div>
        <span>My Documents</span>
      </div>
      
      <div tabindex="2" data-exe="openApp('browser')" class="ui_icon" style="position:absolute;left:0px;top:140px;">
      ...
      <div tabindex="3" data-exe="openApp('quenq')" class="ui_icon" style="position:absolute;left:0px;top:220px;">
       <div class="icon" style="background-image: url('program/assets/quenq.png')"></div>
        <span>Internet Messenger</span>
      </div>
      
       <div tabindex="4" data-exe="openApp('webamp')" class="ui_icon" style="position:absolute;left:0px;top:300px;">
